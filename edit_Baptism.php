<?php
  ...
  if($_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    $sql ="SELECT * FROM baptism WHERE ID=$ID";
    ...
    do{
      ...
      $successMessage = "Baptism details updated correctly";
      header("location: event.php");
      exit;
    }while(true);
  }
