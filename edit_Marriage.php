<?php
  ...
  if($_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    $Groom_phone = $row["Groom_phone"];
    $Bride_name = $row["Bride_name"];
    $Bride_phone = $row["Bride_phone"];
    $Marriage_date = $row["Marriage_date"];
    $Officiator = $row["Officiator"];
  }else{
    //POST method update the data marriage
    $ID =$_POST["ID"];
    ...
    do{
      ...
      $successMessage = "Marriage details updated correctly";
      header("location: event.php");
      exit;
    }while(true);
  }
